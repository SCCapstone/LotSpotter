...
import { r as registerInstance, j as forceUpdate, h, H as Host, i as getElement, e as createEvent } from './index-92848855.js';
import { b as getIonMode, c as config } from './ionic-global-23e7365a.js';
import { r as raf } from './helpers-47d562d2.js';
import { o as openURL, c as createColorClasses, h as hostContext } from './theme-5641d27f.js';
...
var Item = /** @class */ (function () {
    ...
    Item.prototype.labelColorChanged = function (ev) {
    ...
    Item.prototype.getFirstInput = function () {
    ...
    // iOS 14.
    Item.prototype.delegateFocus = function (ev) {
    ...
    Item.prototype.render = function () {
        var _a;
        var _b = this, detail = _b.detail, detailIcon = _b.detailIcon, download = _b.download, labelColorStyles = _b.labelColorStyles, lines = _b.lines, disabled = _b.disabled, href = _b.href, rel = _b.rel, target = _b.target, routerAnimation = _b.routerAnimation, routerDirection = _b.routerDirection;
        var childStyles = {};
        ...
        return (h(Host, { "aria-disabled": disabled ? 'true' : null, class: Object.assign(Object.assign(Object.assign({}, childStyles), labelColorStyles), createColorClasses(this.color, (_a = {
                    'item': true
                },
                _a[mode] = true,
...
var ItemDivider = /** @class */ (function () {
    ...
    ItemDivider.prototype.render = function () {
        ...
        return (h(Host, { class: createColorClasses(this.color, (_a = {},
                ...
                _a['item'] = true,
                _a)) }, h("slot", { name: "start" }), h("div", { class: "item-divider-inner" }, h("div", { class: "item-divider-wrapper" }, h("slot", null)), h("slot", { name: "end" }))));
    };
...
var Label = /** @class */ (function () {
    ...
    Label.prototype.colorChanged = function () {
        this.emitColor();
    };
    Label.prototype.positionChanged = function () {
        this.emitStyle();
    };
    Label.prototype.emitColor = function () {
        var _a;
        var color = this.color;
        this.ionColor.emit((_a = {
                'item-label-color': color !== undefined
            },
            _a["ion-color-" + color] = color !== undefined,
            _a));
    };
...
var ListHeader = /** @class */ (function () {
    ...
    ListHeader.prototype.render = function () {
        ...
        return (h(Host, { class: createColorClasses(this.color, (_a = {},
                ...
                _a)) }, h("div", { class: "list-header-inner" }, h("slot", null))));
    };
    return ListHeader;
}());
ListHeader.style = {
