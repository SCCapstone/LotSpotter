...
export declare type TrafficModel = 'BEST_GUESS' | 'OPTIMISTIC' | 'PESSIMISTIC';
export declare type TransitMode = 'BUS' | 'RAIL' | 'SUBWAY' | 'TRAIN' | 'TRAM';
export declare type TransitRoutePreference = 'FEWER_TRANSFERS' | 'LESS_WALKING';
export declare type UnitSystem = 'IMPERIAL' | 'METRIC';
export declare type TravelMode = 'BICYCLING' | 'DRIVING' | 'TRANSIT' | 'WALKING';
export declare type VehicleType = 'BUS' | 'CABLE_CAR' | 'COMMUTER_TRAIN' | 'FERRY' | 'FUNICULAR' | 'GONDOLA_LIFT' | 'HEAVY_RAIL' | 'HIGH_SPEED_TRAIN' | 'INTERCITY_BUS' | 'METRO_RAIL' | 'MONORAIL' | 'OTHER' | 'RAIL' | 'SHARE_TAXI' | 'SUBWAY' | 'TRAM' | 'TROLLEYBUS';
export declare const TrafficModelId: {
    BEST_GUESS: string;
    OPTIMISTIC: string;
    PESSIMISTIC: string;
};
export declare const TransitModeId: {
    BUS: string;
    RAIL: string;
    SUBWAY: string;
    TRAIN: string;
...
export declare const TransitRoutePreferenceId: {
    FEWER_TRANSFERS: string;
    LESS_WALKING: string;
};
export declare const UnitSystemId: {
    IMPERIAL: string;
    METRIC: string;
};
export declare const TravelModeId: {
    BICYCLING: string;
    DRIVING: string;
    TRANSIT: string;
    WALKING: string;
};
export declare const VehicleTypeId: {
    BUS: string;
    CABLE_CAR: string;
...
export declare const MapTypeId: {
    NORMAL: string;
    ROADMAP: string;
    SATELLITE: string;
    HYBRID: string;
 ...
 * @hidden
 */
export declare class DirectionsRenderer extends BaseClass {
    private _map;
    constructor(_map: GoogleMap, _objectInstance: any);
    /**
     * Returns the ID of instance.
